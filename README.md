...
They have distributed the entire course work into 3 parts: basic, intermediate and advanced. To get hands on experience and a good understanding of the basic and the intermediate modules is my basic goal. Because of my love for coding and the amazing setup module got me so engrossed in learning that I couldn't stop before completing the first module. Things are going to start getting tougher now for sure, but I am looking forward to it. 
